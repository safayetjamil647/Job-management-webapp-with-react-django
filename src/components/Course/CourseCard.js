		...
		<div class="w-full md:w-1/3 bg-white grid place-items-center">
			...
			<div class="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
				<div class="flex justify-between item-center">
					<p class="text-gray-500 font-medium hidden md:block">Frontend</p>
				...
				<h3 class="font-black text-gray-500 md:text-3xl text-xl">Javascript and frontend framework</h3>
				...
				<p class="text-xl font-black text-gray-500">
					$110
					<span class=" mx-2 font-normal text-gray-600 text-base">USD</span>
				</p>
			</div>
		</div>
	</div>
