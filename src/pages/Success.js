      ...
      <div className="flex flex-wrap">
        <div className="w-full md:w-4/12 text-center px-4 ">
          <div>
            ...
            <p className="m-4 text-2xl text-gray-500">Web Development</p>
          ...
          <div>
            <div className="text-center">
              <img
                ...
                src="iconnetworkplus.svg"
                alt="course"
              />
            </div>
            <p className="m-4 text-2xl text-gray-500">Cloud Computing</p>
            <p className="m-2 text-lg text-gray-500">
            Eridium+ is the starting point for a career in IT. The performance-based
              exams certify foundational IT skills across a variety of devices
              and operating systems.
